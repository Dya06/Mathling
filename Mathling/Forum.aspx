  ...
  <main class="main">
    <div class="forum-page container">
      ...
      <div class="forum-filters">
        ...
        <button class="tag forum-filter" data-filter="General">💡 General</button>
        <button class="tag forum-filter" data-filter="Tips">🎯 Tips</button>
        <button class="tag forum-filter" data-filter="Questions">❓ Questions</button>
      </div>
